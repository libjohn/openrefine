...
4. Transform the "major works" column by splitting the column at the pipe:  `|'
    ...
    a. <span class="or-menu"> major works > Edit cells > Trasnform... </span>
    a. Expression = `value.split("|")[1]`
    a. <span class="or-menu"> OK </span>
        
Now, when you <span class="or-menu"> Export </span> as Comma-separated Value (Excel, etc.) All of the reconciled information will be with retained.
