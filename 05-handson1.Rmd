...
<ol>
<div class="challenge">
<li>How many rows are in this dataset? (click to reveal answer)</li>
<p>**Answer:** &nbsp;21,982 rows</p>
</div>
</ol>
...
<p>**Answer:** &nbsp;7633 choices</p>
</div>
<ul><li>You may see a program warning, a dialog-box error message [screen shot](images/facet_max_number.png) prompting you to <i>set the maximum number of choices show in the text facet</i>.  If so, accept the default and proceed.</li></ul>
</ol>
...
<p>**Answer:** &nbsp;238. Compare to your answer in #4 above.</p>
</div>
</ol>
