...
1. [Launch](https://github.com/OpenRefine/OpenRefine/wiki/Installation-Instructions) the Open-Refine icon from your computer (find and double-click the jewel icon)
...
4. In the Facet box, click “count”.  
    + *What is the 4th most popular type of authorized work?  How permits are authorized?*  ([answer](#appendix-facets))
...
1. Select the DECK Facet.  
    + *How many matching rows match the Deck Facet?*  ([answer](#appendix-cluster))
2. Select the SCREEN PORCH facet combined with the DECK Facet.  
    + *Now how many matching rows exist?*  ([answer](#appendix-cluster))
...
4. On the “county” column, make a text facet and limit to Durham County (DURH)  
    + *How many “Single Family” homes got permits in Durham County for Screen Porches or Decks?*  ([answer](#appendix-cluster))
    + *Is the authorized work for Screen Porches, Decks, or both?*  ([answer](#appendix-cluster))
5. Click the “Remove All” button to remove all text facets.  
    + *How many matching rows are in the dataset now?*  ([answer](#appendix-cluster))

<iframe width="560" height="315" src="https://www.youtube.com/embed/QjXkUoFykkk?t=20s" frameborder="0" allowfullscreen></iframe>
