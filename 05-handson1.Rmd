...
3. *How many facets are there?*  ([answer](#appendix-facets))  
    + You may see a program warning, a [dialog-box error](images/facet_max_number.png) prompting you to <i>set the maxiumum number of choices show in the text facet</i>.  Accept the default and proceed.
